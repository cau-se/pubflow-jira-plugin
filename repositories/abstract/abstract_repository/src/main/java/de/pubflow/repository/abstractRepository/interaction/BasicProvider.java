...
package de.pubflow.repository.abstractRepository.interaction;

import java.io.IOException;
import java.util.List;

import de.pubflow.repository.abstractRepository.repository.BasicRepository;
import de.pubflow.repository.abstractRepository.repository.ERepositoryName;
import de.pubflow.repository.abstractRepository.storageAdapter.StorageAdapter;
