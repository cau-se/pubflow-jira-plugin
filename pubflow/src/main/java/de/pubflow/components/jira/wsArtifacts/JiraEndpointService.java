    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(de.pubflow.components.jira.wsArtifacts.JiraEndpointService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = de.pubflow.components.jira.wsArtifacts.JiraEndpointService.class.getResource(".");
