 ...
 *         java7/1507_11_012.html#dodtp7446d10c-f240-4994-b5e3-be87e5992137
 */
public class MailProxy {
			...
			if (m.isMimeType("text/plain"))
				...
				for (int j = 1; j < mp.getCount(); j++) {
					...
					if (disp == null || disp.equalsIgnoreCase(Part.ATTACHMENT)) {
						...
						// Nachricht
						System.out.println("MIME-Typ ist "
	...
	public static void postMultipartTextAndHtmlMail(Session session,
			String recipient, String subject, String txtMsg, String htmlMsg)
			throws MessagingException {
