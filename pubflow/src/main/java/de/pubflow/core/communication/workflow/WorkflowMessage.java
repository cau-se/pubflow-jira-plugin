package de.pubflow.core.communication.workflow;
...
import de.pubflow.common.enumeration.WFState;
...
public class WorkflowMessage extends Message {
	...
	protected WFParameterList 	wfparams 				= null;
	...
	public synchronized WFParameterList getWfparams() {
		return wfparams;
	}
	 ...
	 */
	public synchronized void setWfparams(WFParameterList wfparams) {
