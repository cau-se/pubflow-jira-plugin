...
public class JiraObjectCreator {
	...
	public static String createIssueType(String projectKey, String issueTypeName, ApplicationUser user, String workflowXML, List<String> statuses, LinkedList<CustomFieldDefinition> customFields, List<ConditionDefinition> conditions) throws Exception{
		//Add Workflow
		...
		if(jiraWorkflow == null){
			...
			jiraWorkflow = JiraObjectManipulator.addWorkflow(projectKey, workflowXML, user);
		}
