...
public class CVOOTo4DWorkflow extends AbstractWorkflow {
	...
	public List<CustomFieldDefinition> getCustomFields() {
		...
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Leg ID", CustomFieldType.TEXT, true, new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("PID", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Login", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Source", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Author", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
		...
		customFieldsCVOOTo4D.add(new CustomFieldDefinition("Topology", CustomFieldType.TEXT, false,
				new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Status", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
		...
		customFieldsCVOOTo4D.add(new CustomFieldDefinition("Quartz Cron", CustomFieldType.TEXT, false,
				new String[] { "111", "181", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("DOI", CustomFieldType.TEXT, false, new String[] { "111", "181", "191" }));
