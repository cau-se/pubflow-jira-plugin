...
public class CVOOTo4DIDWorkflow extends AbstractWorkflow {
	...
	public List<CustomFieldDefinition> getCustomFields() {
		...
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Reference", CustomFieldType.TEXT, false, new String[] { "111", "131", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("File Name", CustomFieldType.TEXT, false, new String[] { "111", "131", "191" }));
		customFieldsCVOOTo4D.add(
				new CustomFieldDefinition("Leg Comment", CustomFieldType.TEXT, false, new String[] { "111", "131", "191" }));
		customFieldsCVOOTo4D.add(
